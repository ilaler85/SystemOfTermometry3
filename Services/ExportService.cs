...
public static class ExportService
{
    ...
    /// <returns>false если уже в процессе экспорта</returns>
    public static bool exportToExcelAsync(string filepath, SilosService silosService, SettingsService settingsService, DateTime time, ExportCallbackDelegate callback)
    {
        if (inExport)
            return false;
